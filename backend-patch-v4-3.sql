-- Support Request Portal backend patch v4.3
-- Fixes blank cases by validating required customer fields in the backend.
-- Also keeps category normalisation tolerant of older frontend values.
